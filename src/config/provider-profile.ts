...
// Provider profiles deliberately do NOT claim per-model feature capabilities;
// those are logical-model declarations, with only obvious internal
// contradictions validated by config.
