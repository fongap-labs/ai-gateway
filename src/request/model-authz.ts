...
// of every explicit `node.models` key and every AIG_MODELS_CONFIG key. This is
...
//   * authz.allowAll ("*" = legacy key or AIG_ACCESS_MODELS_<GROUP>="*")
...
// (legacy key or AIG_ACCESS_MODELS_<GROUP>="*"), the entire catalog is
