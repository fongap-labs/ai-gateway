...
//
// Topology policy: by default terminal errors expose only gateway-owned
...
function familyFailureSetIsRetryable(failureKinds?: Partial<Record<FailureKind, number>>): boolean {
