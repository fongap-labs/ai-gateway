...
| [module-boundary-audit.md](architecture/module-boundary-audit.md) | 2026-09-16 source audit of module cohesion, duplication, boundary debt, and staged refactor priorities |
