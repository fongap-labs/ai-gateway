...
- follow a URL or redirect that fails structural or DNS-backed SSRF validation unless `AIG_CAN_DISCOVER_PRIVATE_PROVIDERS` is explicitly enabled for a trusted private provider;
