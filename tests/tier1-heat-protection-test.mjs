...
import {
  __resetTier1StateForTests, claimTier1Slot, releaseTier1Slot,
...
import {
  ...
  tier1AffinityHeatFactor, tier1CanAcceptHedge, tier1ConcurrencyPressure, tier1SelectionHeatFactor,
