...
const UNIT_TESTS = [
  ...
  'tests/logical-tier-policy-inference-test.mjs',
  ...
  'tests/cooldown-jitter-test.mjs',
  ...
  'tests/dashboard-consumption-semantics-test.mjs',
  'tests/readme-status-test.mjs',
  ...
  'tests/ci-migration-immutability-contract-test.mjs',
  'tests/secret-scan-typescript-fixture-test.mjs',
  'tests/architecture-contract-test.mjs',
  'tests/module-boundary-contract-test.mjs',
